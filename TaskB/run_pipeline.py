"""
Full pipeline runner for Task B.
...
Runs all steps in order:
  ...
  3. train.py              — train the hybrid classifier (11-class authorship)
...
# Always run every subprocess from TaskB/ regardless of where the user invoked this script
...
def main():
    parser = argparse.ArgumentParser(description="Run the full Task B pipeline.")
    parser.add_argument(
    ...
    print(f"\nPipeline: Task B (11-class authorship) — {len(steps_to_run)} step(s) selected")
