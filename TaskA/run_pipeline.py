"""
Full pipeline runner for Task A.
...
Runs all steps in order:
  ...
  3. train.py              — train the hybrid classifier
...
# Always run every subprocess from TaskA/ regardless of where the user invoked this script
...
def main():
    parser = argparse.ArgumentParser(description="Run the full Task A pipeline.")
    parser.add_argument(
    ...
    print(f"\nPipeline: Task A — {len(steps_to_run)} step(s) selected")
