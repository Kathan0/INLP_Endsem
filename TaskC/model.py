...
class TaskCModel(nn.Module):
    def __init__(self, config: dict):
        ...
        # Fusion + classifier
        num_labels = config['model']['num_labels']  # 4
